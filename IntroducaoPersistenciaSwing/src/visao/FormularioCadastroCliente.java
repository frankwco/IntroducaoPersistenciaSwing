 ...
 * @author Aluno
 */
public class FormularioCadastroCliente extends javax.swing.JDialog {

    private Cliente cliente;
    private DAOCliente dao;

    /**
     * Creates new form FormularioCadastroCliente
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioCadastroCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormularioCadastroCliente dialog = new FormularioCadastroCliente(new javax.swing.JFrame(), true);
